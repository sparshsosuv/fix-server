...
@Controller
@RequestMapping(value = "/fix/initiator")
public class FixInitiatorResource {
    ...
    public ResponseEntity<List<SessionID>> sessions() {
        return ResponseEntity.ok( initiator.getSessions() );
    }
    ...
    public ResponseEntity<FixSessionRepresentation> getSession(
        ...
        try {
            final List<SessionID> sessionList = initiator.getSessions();
