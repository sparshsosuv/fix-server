...
//    }
    ...
    public Message setTagValue(Message message, int tag, String value) throws IncorrectTagValue, FieldNotFound, InvalidMessage, ConfigError {
        ...
        if (existingTagIndex != -1 && existingTagValue != null) {
            ...
            return new Message(updatedFixString, new DataDictionary("/Users/Sparsh Shukla/Documents/repos_BE/sosuv-fix-server/src/main/resources/fix/FIX44.xml"), false);
        } else {
            int tag10Index = fixString.indexOf("10=");
            String newTagString = tag + "=" + value + '\u0001';
            if (tag10Index == -1) {
                return new Message(fixString + newTagString, new DataDictionary("/Users/Sparsh Shukla/Documents/repos_BE/sosuv-fix-server/src/main/resources/fix/FIX44.xml"), false);
            }
            return new Message(fixString.substring(0, tag10Index) + newTagString + fixString.substring(tag10Index), new DataDictionary("/Users/Sparsh Shukla/Documents/repos_BE/sosuv-fix-server/src/main/resources/fix/FIX44.xml"), false);
        }
    }
